...
<p>在1995年，三十多岁的布兰登·艾奇（Brendan Eich）花了十天时间开发出了这门语言。
最初这门语言叫livescript,后来改名为javascript
javascript的名字是蹭了java的热度，其实跟java没有半毛钱关系。
我想他无论如何都不会想到javascript会成为世界上最重要的语言之一。</p>
<p>最初javascript是只能在浏览器里运行的脚本语言。
后来由于google开发的v8引擎
...
因此对它有一种特殊的感情。
我会在后续的几期视频中， 教大家从一个小白成为javascript高手。</p>
</template>
